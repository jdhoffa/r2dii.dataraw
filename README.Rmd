...
[![Travis build status](https://travis-ci.org/2DegreesInvesting/r2dii.dataraw.svg?branch=master)](https://travis-ci.org/2DegreesInvesting/r2dii.dataraw)
[![Codecov test coverage](https://codecov.io/gh/2degreesinvesting/r2dii.dataraw/branch/master/graph/badge.svg)](https://codecov.io/gh/2degreesinvesting/r2dii.dataraw?branch=master)
<!-- badges: end -->
